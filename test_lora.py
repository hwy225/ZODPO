...
def plot_loss(loss_history, save_path="mezo_dpo_loss_lora.png"):
...
def main():
    ...
    # get_peft_model will automatically convert base_policy_model to bfloat16 and move to GPU
    ...
    print("[3/3] Training...")
    mezo = MeZOOptimizer(policy_model, lr=5e-4, eps=1e-3)
